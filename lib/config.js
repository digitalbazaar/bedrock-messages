...
config.messages.scheduler = {};
// Set how often the scheduler background-job will run
config.messages.scheduler.frequency = 'R/PT1M';
// Set priority of this background job
config.messages.scheduler.priority = 0;
// Set max amount of bedrock workers on the scheduling job
config.messages.scheduler.concurrency = -1;
...
roles['messages.registered'] = {
  id: 'messages.registered',
  label: 'Messages User',
