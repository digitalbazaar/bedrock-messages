...
function update(request, callback) {
  ...
  if(request.operation === 'archive') {
    ...
    request.error = new BedrockError(request.operation + ' is not a suitable update operation');
...
function batchUpdate(request, callback) {
  ...
  if (!request.messages) {
    request.result = 'failed';
    request.error = new BedrockError('No messages supplied');
