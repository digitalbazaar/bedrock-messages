...
api._batchMessagePhase1 = function(batch, message, done, callback) {
  batchMessagePhase1(batch, message, done, callback);
}
api._batchMessagePhase2 = function(batch, message, done, callback, results) {
  batchMessagePhase2(batch, message, done, callback, results);
}
api._batchMessagePhase3 = function(batch, message, done, callback, results) {
  batchMessagePhase3(batch, message, done, callback, results);
}
...
api._closeBatchPhase1 = function(recipient, done, callback) {
  closeBatchPhase1(recipient, done, callback);
};
api._closeBatchPhase2 = function(recipient, done, callback, results) {
  closeBatchPhase2(recipient, done, callback, results);
};
api._closeBatchPhase3 = function(recipient, done, callback, results) {
  closeBatchPhase3(recipient, done, callback, results);
};
api._closeBatchPhase4 = function(recipient, done, callback, results) {
  closeBatchPhase4(recipient, done, callback, results);
};
...
function batchMessagePhase1(batch, message, done, callback) {
  var q = {
...
function batchMessagePhase2(batch, message, done, callback, results) {
  if(results.updateBatch.matchedCount === 0) {
    console.log("%%%%%%Batch was already delivered");
    // batch was delivered
...
function batchMessagePhase3(batch, message, done, callback, results) {
  if(results.updateMessage.modifiedCount === 0) {
    // another process is handling the message
    console.log("Another process is handling the message");
    return done(null, null);
  }
...
function closeBatchPhase1(recipient, done, callback) {
  readBatch(recipient, callback);
}
//Test if batch increments mid-update
function closeBatchPhase2(recipient, done, callback, results) {
...
function closeBatchPhase3(recipient, done, callback, results) {
...
function closeBatchPhase4(recipient, done, callback, results) {
  //console.log(results.updateBatch);
  if(!results.updateBatch || !results.updateBatch.value) {
    return done(null, null);
  }
  // value.value crashes app if no batch found
  var batch = results.updateBatch.value.value;
  var q = {
    'value.meta.batch.id': batch.id,
    'value.meta.batch.state': 'ready'
