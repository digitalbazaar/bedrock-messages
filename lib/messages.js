...
config.scheduler.jobs.push({
  ...
  schedule: config.messages.batchMessageScheduler.frequency,
  priority: config.messages.batchMessageScheduler.priority,
  concurrency: config.messages.batchMessageScheduler.concurrency
});
